...
public class Main {
    ...
    public static int execute(String[] args) {
        ...
        Pair<Collection<AgentProjectInfo>,StatusCode> projects = getAllProjects(fileSystemAgentConfiguration);
    ...
    public static Pair<Collection<AgentProjectInfo>,StatusCode> getAllProjects(FileSystemAgentConfiguration fileSystemAgentConfiguration) {
