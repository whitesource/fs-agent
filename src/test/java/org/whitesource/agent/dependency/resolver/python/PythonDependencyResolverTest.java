...
public class PythonDependencyResolverTest {
    ...
    public void shouldFindDependecies() {
        ...
        PythonDependencyResolver pythonDependencyResolver = new PythonDependencyResolver("python.exe", "pip3.exe", false, false, false, new String[]{Constants.PYTHON_REQUIREMENTS}, true);
